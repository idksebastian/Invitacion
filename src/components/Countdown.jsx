...
const IconHeart = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="inline-block text-cream-400 mx-1">
...
function FlipDigit({ value, label }) {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div
        className="digit-box w-16 h-16 md:w-20 md:h-20 flex items-center justify-center"
      ...
      <span className="font-sans text-[10px] tracking-[0.3em] uppercase text-cream-500">
        {label}
      </span>
    </div>
  )
...
export default function Countdown() {
  ...
  return (
    <section className="py-20 px-6 flex flex-col items-center">
      ...
      <p className="font-sans text-sm text-cream-500 mb-10 text-center animate-fade-up delay-200 flex items-center justify-center gap-1">
        Soy un bebé con el corazón latiéndome muy rápido <IconHeart />
      </p>

      {time.done ? (
        <p className="font-serif text-2xl italic text-cream-700 animate-fade-in">
      ...
      <div className="mt-12 ornament w-full max-w-xs animate-fade-in delay-400">
